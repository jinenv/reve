        ...
        async def _operation():
            ...
            async with DatabaseService.get_transaction() as session:
                ...
                player = Player(
                    ...
                    weekly_points=0,
                    last_weekly_reset=datetime.utcnow().date(),
                    last_daily_echo=None,  # This can be null
                    total_battles=0,
                    battles_won=0,
                    total_fusions=0,
                    successful_fusions=0,
                    total_awakenings=0,
                    total_echoes_opened=0,
                    collections_completed=0,
                    favorite_element=None,  # This can be null
                    friend_code=None,  # This can be null
                    guild_id=None,  # This can be null
                    guild_contribution_points=0,
                    last_quest=None,  # This can be null
                    last_fusion=None,  # This can be null
                    total_revies_earned=starter_config.get("starting_revies", 1000),
                    total_erythl_earned=starter_config.get("starting_erythl", 0),
                    total_energy_spent=0,
                    total_stamina_spent=0,
                    skill_reset_count=0,
                    upkeep_paid_until=datetime.utcnow(),
                    total_upkeep_cost=0,
                    last_upkeep_calculation=datetime.utcnow(),
                    total_buildings_owned=0,
                    total_passive_income_collected=0,
                    total_upkeep_paid=0,
                    times_went_bankrupt=0,
                    achievements_earned=[],
