...
class Tiers:
    ...
    _TIER_DATA = {
        ...
        6: TierData(6, "Celestial", "VI", (7000, 15000), 11000, 0.55, 40000, 25, (2, 5), 0x9932cc),
        7: TierData(7, "Divine", "VII", (25000, 50000), 37500, 0.50, 100000, 50, (3, 8), 0xff8c00),
        8: TierData(8, "Primal", "VIII", (80000, 180000), 130000, 0.45, 250000, 50, (3, 8), 0xff0066),
        9: TierData(9, "Sovereign", "IX", (300000, 650000), 475000, 0.40, 800000, 50, (3, 8), 0xffff00),
        10: TierData(10, "Astral", "X", (1000000, 2200000), 1600000, 0.35, 3000000, 100, (5, 12), 0x00ffff),
        11: TierData(11, "Ethereal", "XI", (3500000, 7500000), 5500000, 0.30, 10000000, 100, (5, 12), 0x00ffff),
        12: TierData(12, "Transcendent", "XII", (12000000, 27000000), 19500000, 0.28, 50000000, 100, (5, 12), 0x00ffff),
        13: TierData(13, "Empyrean", "XIII", (40000000, 90000000), 65000000, 0.26, 150000000, 250, (8, 18), 0x00ffff),
        14: TierData(14, "Absolute", "XIV", (140000000, 320000000), 230000000, 0.24, 500000000, 250, (8, 18), 0x00ffff),
        15: TierData(15, "Genesis", "XV", (500000000, 1100000000), 800000000, 0.22, 1500000000, 250, (8, 18), 0x00ffff),
        16: TierData(16, "Legendary", "XVI", (1700000000, 3800000000), 2750000000, 0.21, 5000000000, 500, (12, 25), 0x00ffff),
        17: TierData(17, "Void", "XVII", (2400000000, 5500000000), 3950000000, 0.205, 15000000000, 500, (12, 25), 0x00ffff),
        18: TierData(18, "Singularity", "XVIII", (3000000000, 8000000000), 5500000000, 0.20, 50000000000, 500, (12, 25), 0x00ffff)
    }
